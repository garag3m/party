    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ministrante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inscrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inscrito', to='core.Evento')),
            ],
        ),
        migrations.CreateModel(
            name='Inscrito',
